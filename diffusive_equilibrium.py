...
fried_egg_kappa_integrand = lambda eta, k0_in, z_in: z_in*np.exp(z_in*(1. - 1./eta))*(eta ** (k0_in - 2.0))
...
def diff_eq(Pos_in, Pos0_in, Bratio, species0, deltaU, posc, nchoke, phic, planet, fcor, if_psh):
