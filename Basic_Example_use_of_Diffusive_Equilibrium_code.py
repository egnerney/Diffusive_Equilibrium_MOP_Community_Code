...
#mpmath.mp.dps = 15  # 15 decimal places
...
if __name__ == '__main__':
    ...
    # Set all 10 species to distribution type to Anisotropic Maxwellians, They need not all be the same
    #species_type = ['Aniso_Maxwellian'] * nspec 
    #species_type = ['Aniso_Maxwellian_const_Tperp'] * nspec 
    #species_type = ['Maxwellian'] * nspec 
    ...
    plt.grid()
    plt.savefig(species_type[0] + "_diff_eq_densities_vs_s_log_aligned_Io_fl.png", dpi=800, bbox_inches="tight")
    plt.show()
    ...
    plt.legend(fontsize='x-small', ncol=2)
    plt.grid()
    plt.savefig(species_type[0] + "_diff_all_eq_densities_vs_lat_log_aligned_Io_fl.png", dpi=800, bbox_inches="tight")
    plt.show()
    ...
    plt.legend(fontsize='x-small', ncol=2)
    plt.grid()
    plt.savefig(species_type[0] + "_all_diff_eq_Tpar_vs_lat_log_aligned_Io_fl.png", dpi=800, bbox_inches="tight")
    plt.show()
    ...
    plt.legend(fontsize='x-small', ncol=2)
    plt.grid()
    plt.savefig(species_type[0] + "_all_diff_eq_Tperp_vs_lat_log_aligned_Io_fl.png", dpi=800, bbox_inches="tight")
    plt.show()
    ...
    plt.legend(fontsize='x-small', ncol=2)
    plt.grid()
    plt.savefig(species_type[0] + "_all_diff_eq_kappa_par_vs_lat_log_aligned_Io_fl.png", dpi=800, bbox_inches="tight")
    plt.show()
    ...
    plt.legend(fontsize='x-small', ncol=2)
    plt.grid()
    plt.savefig(species_type[0] + "_all_diff_eq_kappa_perp_vs_lat_log_aligned_Io_fl.png", dpi=800, bbox_inches="tight")
    plt.show()
